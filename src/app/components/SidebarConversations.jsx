...
export function SidebarSupportConversations({ conversations = [], activeChatId, onSelectChat }) {
    ...
    const senderNames = (sender) => {
        if (sender === "Support") return "Siz";
        if (sender === "User") return "Müşteri";
        if (sender === "System") return "Sistem";
        return sender;
    };
    ...
    return (
        <>
            {conversations.map((conversation) => {
                const isActive = activeChatId === conversation.ticketId;
...
export function SidebarCustomerConversations( { conversations = [], activeChatId, onSelectChat } ) {
    ...
    const senderNames = (sender) => {
        if (sender === "Support") return "Temsilci";
        if (sender === "User") return "Siz";
        if (sender === "System") return "Sistem";
        return sender;
    }
